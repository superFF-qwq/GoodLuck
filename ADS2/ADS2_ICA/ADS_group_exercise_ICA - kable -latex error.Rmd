...
ggplot(data = substance_use,
  ...
  labs(x = "Cause", y = "Value", color = "Group") +
  theme_bw() +
...
The range of the value is normal. From Figure 0, You can see some outliers. However, if you draw the plots for each location, age and sex, you will find that the data looks pretty nice. Due to the page limit, we do not show the plots. Therefore, we dicide not to delete the outliers in Figure 0.
...
ggplot(data1, aes(x = location, y = val, color = location)) +
  geom_boxplot(outlier.size = 0.1) +
...
ggplot(data2, aes(x = age, y = diff, color = age)) +
  geom_boxplot(outlier.size = 0.1) +
